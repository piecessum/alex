  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
    ...
    <Panel label="Что изменилось">
      <div className="space-y-3">
        ...
        <Swap from="вопросы в поддержку" to="−20% обращений" />
        <Swap from="разнобой в вёрстке" to="единая дизайн-система" />
      </div>
      <p className="mt-5 text-xs leading-relaxed text-neutral-500 dark:text-neutral-400">
        Пользователи дали приятный фидбэк, а вёрстка ускорилась за счёт
        стандартизации.
      </p>
    </Panel>
  </div>
