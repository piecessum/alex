      ...
      <article className="mx-auto max-w-4xl px-6 py-16 sm:py-20">
        ...
        {c.bpmn && (
          <section className="mt-14">
            ...
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-neutral-600 dark:text-neutral-400">
              Рассмотрим на схеме ветвление сценариев: один поток пользователя,
              развилка «как ищет?», две ветки — по спецификации и по категории —
              сходятся в добавление товара в спецификацию или КП.
            </p>
            <CaseBpmn />
          </section>
        )}
